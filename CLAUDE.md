...
**YOU ARE IN: `factions/polecats/scavenger/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/factions/` (rig root) or other directories
...
**Your mail address:** `factions/polecats/scavenger`
**Your rig:** factions
**Your Witness:** `factions/witness`
...
| Ask Witness for help | `gt mail send factions/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`factions/witness`) when:
...
```bash
gt mail send factions/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
